...
arm-linux-gnueabi-gcc -march=armv5 -shared -fpic -std=gnu99 -Wall *.c -I . -I libancillary \
...
arm-linux-gnueabihf-gcc -march=armv7-a -shared -fpic -std=gnu99 -Wall *.c -I . -I libancillary \
